...
interface NewsRepository {
    ...
    suspend fun getEverything(searchTerm: String, page: Int): Flow<ApiResult<List<ArticleNews>>>
    suspend fun getTopHeadlines(searchTerm: String, page: Int): Flow<ApiResult<List<ArticleNews>>>
